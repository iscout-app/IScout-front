...
// Dados mock
const mockPlayers = [
    { id: 1, nome: 'João Silva Santos', posicao: 'Meia', categoria: 'sub-15', emailResponsavel: 'responsavel@iscout.com' },
    { id: 2, nome: 'Pedro Henrique Costa', posicao: 'Atacante', categoria: 'sub-13', emailResponsavel: 'outro@email.com' },
    { id: 3, nome: 'Lucas Oliveira', posicao: 'Zagueiro', categoria: 'sub-17', emailResponsavel: 'responsavel@iscout.com' },
    { id: 4, nome: 'Gabriel Ferreira', posicao: 'Volante', categoria: 'sub-15', emailResponsavel: 'outro2@email.com' },
    { id: 5, nome: 'Rafael Souza', posicao: 'Goleiro', categoria: 'sub-13', emailResponsavel: 'responsavel@iscout.com' },
    { id: 6, nome: 'Matheus Lima', posicao: 'Lateral Direito', categoria: 'sub-15', emailResponsavel: 'outro3@email.com' }
];

const mockStats = [
    { id: 1, jogadorId: 1, tipoEvento: 'partida', dataEvento: '2024-11-20', gols: 1, assistencias: 2, notaDesempenho: 8.5 },
    { id: 2, jogadorId: 1, tipoEvento: 'treino', dataEvento: '2024-11-18', gols: 0, assistencias: 0, notaDesempenho: 7.5 },
    { id: 3, jogadorId: 1, tipoEvento: 'partida', dataEvento: '2024-11-15', gols: 0, assistencias: 1, notaDesempenho: 6.5 },
    { id: 4, jogadorId: 1, tipoEvento: 'treino', dataEvento: '2024-11-12', gols: 2, assistencias: 1, notaDesempenho: 8.0 },
    { id: 5, jogadorId: 1, tipoEvento: 'partida', dataEvento: '2024-11-08', gols: 2, assistencias: 0, notaDesempenho: 9.0 },
    { id: 6, jogadorId: 3, tipoEvento: 'partida', dataEvento: '2024-11-19', gols: 1, assistencias: 0, notaDesempenho: 9.0 },
    { id: 7, jogadorId: 3, tipoEvento: 'treino', dataEvento: '2024-11-16', gols: 0, assistencias: 0, notaDesempenho: 8.5 },
    { id: 8, jogadorId: 5, tipoEvento: 'treino', dataEvento: '2024-11-21', gols: 0, assistencias: 0, notaDesempenho: 7.0 },
    { id: 9, jogadorId: 2, tipoEvento: 'partida', dataEvento: '2024-11-17', gols: 3, assistencias: 1, notaDesempenho: 9.5 },
    { id: 10, jogadorId: 4, tipoEvento: 'treino', dataEvento: '2024-11-14', gols: 1, assistencias: 2, notaDesempenho: 8.0 }
];
...
function getStatsForUser() {
    const players = getPlayersForUser();
    const playerIds = players.map(p => p.id);
    return mockStats.filter(s => playerIds.includes(s.jogadorId));
}

const availablePlayers = getPlayersForUser();
const availableStats = getStatsForUser();
